...
/*
    ...
    fun `invoke marks set as complete from inProgressResults`() {
        // Given
        val sets = listOf(
            LoggingStandardSet(position = 0, initialWeightRecommendation = 100f, initialWeightRecommendation = 100f, weightRecommendation = 100f, repRangeBottom = 5, rpeTarget = 8f, complete = false, repRangeTop = 8,   previousSetResultLabel = "")
        )
        val lifts = listOf(
    ...
    fun `invoke marks previously complete set as incomplete`() {
        // Given
        val sets = listOf(
            LoggingStandardSet(position = 0, initialWeightRecommendation = 100f, initialWeightRecommendation = 100f, weightRecommendation = 100f, repRangeBottom = 5, rpeTarget = 8f, complete = true, completedWeight = 100f, completedReps = 5, completedRpe = 8f, repRangeTop = 8,   previousSetResultLabel = "")
        )
        val lifts = listOf(
            LoggingWorkoutLift(id = 1, liftId = 101, liftName = "Squat", position = 0, sets = sets, liftMovementPattern = MovementPattern.LEG_PUSH, liftVolumeTypes = 1, liftSecondaryVolumeTypes = null, progressionScheme = ProgressionScheme.LINEAR_PROGRESSION, incrementOverride = null, restTime = 90.seconds, restTimerEnabled = true, deloadWeek = null, note = null, isCustom = false)
        )
    ...
    fun `getWithWeightRecommendation - drop set uses last weight times (1 - dropPercent) and rounds to increment`() {
        ...
        val lastCompleted = LoggingStandardSet(
            position = 0,
            initialWeightRecommendation = 100f, initialWeightRecommendation = 100f, weightRecommendation = 100f,
            repRangeBottom = 5,
            repRangeTop = 8,
            rpeTarget = 8f,
            complete = true,
        ...
        val dropSet = LoggingDropSet(
            ...
            initialWeightRecommendation = null, initialWeightRecommendation = null, weightRecommendation = null,
            complete = false,
            repRangeBottom = 5,
            repRangeTop = 8,
            rpeTarget = 8f,
        ...
        val result = hydrateLoggingWorkoutWithCompletedSetsUseCase(listOf(myLift), listOf(setResultForLastCompleted), microCycle = 0, 4)
    ...
    fun `getWithWeightRecommendation - standard set recalculates when too easy by threshold aiming at bottom`() {
        ...
        val lastCompleted = LoggingStandardSet(
            position = 0,
            initialWeightRecommendation = 80f, initialWeightRecommendation = 80f, weightRecommendation = 80f,
    ...
    fun `getWithWeightRecommendation - standard set recalculates when bottom or RPE goal changed aiming at top`() {
        ...
        val lastCompleted = LoggingStandardSet(
            position = 0,
            initialWeightRecommendation = 90f, initialWeightRecommendation = 90f, weightRecommendation = 90f,
    ...
    fun `standard after drop does NOT recalc and leaves recommendation untouched`() {
        ...
        val nextStandard = LoggingStandardSet(
            position = 1,
            initialWeightRecommendation = null, initialWeightRecommendation = null, weightRecommendation = null, // should remain null since gate prohibits recalc
            repRangeBottom = 6, repRangeTop = 8, rpeTarget = 8f,
            complete = false,
        ...
        // When
        val hydrated = hydrateLoggingWorkoutWithCompletedSetsUseCase(listOf(myLift), results, microCycle = 0, 4).first()
    ...
    fun `myo first mini does NOT recalc when activation within adjusted range`() {
        val activation = LoggingMyoRepSet(
            ...
            rpeTarget = 8f,
            repRangeBottom = 12, repRangeTop = 15,
            initialWeightRecommendation = 120f, initialWeightRecommendation = 120f, weightRecommendation = 120f,
...
// ====================== Myo-rep recommendation & behavior ======================
    ...
    fun `myo first mini recalculates when activation outside adjusted range (too easy)`() {
        ...
        val activation = LoggingMyoRepSet(
            ...
            initialWeightRecommendation = 95f, initialWeightRecommendation = 95f, weightRecommendation = 95f,
    ...
    fun `standard next set leaves recommendation unchanged when previous set is incomplete`() {
        ...
        val hydrated = hydrateLoggingWorkoutWithCompletedSetsUseCase(listOf(myLift), emptyList()).first()
        val updated = hydrated.sets[1] as LoggingStandardSet
    ...
    fun `standard with same rep range uses last completed weight when previous succeeded AND this set had no recommendation`() {
        val prev = LoggingStandardSet(
            position = 0,
            initialWeightRecommendation = 92.5f, initialWeightRecommendation = 92.5f, weightRecommendation = 92.5f, // previous recommendation (doesn't matter, we look at completedWeight)
            repRangeBottom = 6, repRangeTop = 8, rpeTarget = 8f,
            complete = true,
            completedWeight = 100f,
            completedReps = 8,
        ...
        val next = LoggingStandardSet(
            position = 1,
            initialWeightRecommendation = null, initialWeightRecommendation = null, weightRecommendation = null, // <- null triggers the "use last completed weight" branch when prior succeeded
            repRangeBottom = 6, repRangeTop = 8, rpeTarget = 8f,
            complete = false,
    ...
    fun `standard with same rep range keeps current recommendation when previous succeeded and rec matches previous`() {
        ...
        val next = LoggingStandardSet(
            position = 1,
            initialWeightRecommendation = 95f, initialWeightRecommendation = 95f, weightRecommendation = 95f, // same as prev's recommendation -> keep it
            repRangeBottom = 5, repRangeTop = 7, rpeTarget = 8f,
            complete = false,
              previousSetResultLabel = ""
        )
    ...
    fun `standard with different rep range and successful previous keeps existing recommendation (no recalc)`() {
        ...
        val next = LoggingStandardSet(
            position = 1,
            initialWeightRecommendation = 125f, initialWeightRecommendation = 125f, weightRecommendation = 125f, // already has a rec -> keep it since prev succeeded and range changed
    ...
    fun `drop set after myo previous does nothing (type guard)`() {
        val prevMyo = LoggingMyoRepSet(
            ...
            repRangeBottom = 12, repRangeTop = 15, initialWeightRecommendation = 100f, initialWeightRecommendation = 100f, weightRecommendation = 100f,
             previousSetResultLabel = "",
        ...
        val nextDrop = LoggingDropSet(
            ...
            initialWeightRecommendation = null, initialWeightRecommendation = null, weightRecommendation = null, complete = false,
            repRangeBottom = 6, repRangeTop = 8, rpeTarget = 8f,
              previousSetResultLabel = ""
        )
        val myLift = LoggingWorkoutLift(
    ...
    fun `myo second mini copies previous mini completed weight`() {
        ...
        val myLift = LoggingWorkoutLift(
            id = 1, initialWeightRecommendation = null
        )

        val myLift = LoggingWorkoutLift(
            id = 1, weightRecommendation = null
        )
        ...
        val hydrated = hydrateLoggingWorkoutWithCompletedSetsUseCase(listOf(myLift), results, microCycle = 0, programDeloadWeek = 4).first()
