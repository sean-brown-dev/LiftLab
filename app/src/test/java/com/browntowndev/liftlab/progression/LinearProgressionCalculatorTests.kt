...
class LinearProgressionCalculatorTests {
    ...
    fun `all sets increment`() {
        ...
        val previousSetData = listOf(
            LinearProgressionSetResultDto(missedLpGoals = 0, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 0, weight = 75f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
            LinearProgressionSetResultDto(missedLpGoals = 0, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 0, weight = 75f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
            LinearProgressionSetResultDto(missedLpGoals = 0, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 0, weight = 75f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
        )
    ...
    fun `sets do not increment on first failure`() {
        ...
        val previousSetData = listOf(
            LinearProgressionSetResultDto(missedLpGoals = 1, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 0, weight = 75f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
            LinearProgressionSetResultDto(missedLpGoals = 1, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 1, weight = 75f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
            LinearProgressionSetResultDto(missedLpGoals = 1, reps = 5, rpe = 8f, liftPosition = 0, setPosition = 2, weight = 75f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
        )
    ...
    fun `weight drops 10% on second failure`() {
        ...
        val previousSetData = listOf(
            LinearProgressionSetResultDto(missedLpGoals = 2, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 0, weight = 100f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
            LinearProgressionSetResultDto(missedLpGoals = 2, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 1, weight = 100f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
            LinearProgressionSetResultDto(missedLpGoals = 2, reps = 5, rpe = 8f, liftPosition = 0, setPosition = 2, weight = 100f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
        )
    ...
    fun `throws exception if invalid set type passed in`() {
        ...
        val previousSetData = listOf(
            StandardSetResultDto(missedLpGoals = 2, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 0, weight = 100f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0, setType = SetType.STANDARD),
            LinearProgressionSetResultDto(missedLpGoals = 2, reps = 8, rpe = 8f, liftPosition = 0, setPosition = 0, weight = 100f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
            LinearProgressionSetResultDto(missedLpGoals = 2, reps = 7, rpe = 8f, liftPosition = 0, setPosition = 0, weight = 100f, microCycle = 0, workoutId = 0, liftId = 0, mesoCycle = 0),
        )
