    ...
    val volumesByLocalDate = workoutLogs
        ...
        .fastMap { workoutLog ->
            ...
            VolumeTypesForDate(
                ...
                // ⚡ Bolt: Replaced .filter { ... }.size with .count { ... } to prevent unnecessary intermediate List allocation.
                // Expected Impact: Reduces memory allocation O(N) -> O(1) and iterates once instead of twice for counting elements.
