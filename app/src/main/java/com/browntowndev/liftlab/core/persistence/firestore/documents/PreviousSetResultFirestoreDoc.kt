...
@Keep
data class PreviousSetResultFirestoreDoc(
    ...
    override fun copyWithBase(): BaseFirestoreDoc {
        return this.copy().apply {
            firestoreId = this@PreviousSetResultFirestoreDoc.firestoreId
            lastUpdated = this@PreviousSetResultFirestoreDoc.lastUpdated
            synced = this@PreviousSetResultFirestoreDoc.synced
        }
    }
}
