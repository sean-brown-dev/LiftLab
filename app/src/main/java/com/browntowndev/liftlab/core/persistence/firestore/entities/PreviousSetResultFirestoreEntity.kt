...
@Keep
data class PreviousSetResultFirestoreEntity(
    ...
    override fun copyWithBase(): BaseFirestoreEntity {
        return this.copy().apply {
            firestoreId = this@PreviousSetResultFirestoreEntity.firestoreId
            lastUpdated = this@PreviousSetResultFirestoreEntity.lastUpdated
            synced = this@PreviousSetResultFirestoreEntity.synced
        }
    }
}
