...
@Keep
data class SetLogEntryFirestoreDoc(
    ...
    override fun copyWithBase(): BaseFirestoreDoc {
        return this.copy().apply {
            firestoreId = this@SetLogEntryFirestoreDoc.firestoreId
            lastUpdated = this@SetLogEntryFirestoreDoc.lastUpdated
            synced = this@SetLogEntryFirestoreDoc.synced
        }
    }
}
