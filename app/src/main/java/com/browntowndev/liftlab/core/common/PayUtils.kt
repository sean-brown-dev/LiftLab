...
object PayUtils {
    ...
    private val gatewayTokenizationSpecification: JSONObject =
        JSONObject()
            ...
            .put("parameters", JSONObject(PayConstants.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS))
     ...
     */
    private val allowedCardNetworks = JSONArray(PayConstants.SUPPORTED_NETWORKS)
     ...
     * See [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(PayConstants.SUPPORTED_METHODS)
    ...
    * */
    ...
    private fun getTransactionInfo(price: String): JSONObject =
        JSONObject()
            ...
            .put("countryCode", PayConstants.COUNTRY_CODE)
            .put("currencyCode", PayConstants.CURRENCY_CODE)
