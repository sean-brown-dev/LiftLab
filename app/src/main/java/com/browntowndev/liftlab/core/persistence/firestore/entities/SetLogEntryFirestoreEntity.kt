...
@Keep
data class SetLogEntryFirestoreEntity(
    ...
    override fun copyWithBase(): BaseFirestoreEntity {
        return this.copy().apply {
            firestoreId = this@SetLogEntryFirestoreEntity.firestoreId
            lastUpdated = this@SetLogEntryFirestoreEntity.lastUpdated
            synced = this@SetLogEntryFirestoreEntity.synced
        }
    }
}
